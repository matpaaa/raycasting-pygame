...
class Assets:
    ...
    def load():
        ...
        Assets.settings = pygame.image.load('./app/assets/screens/settings.png').convert_alpha()
        Assets.loading = pygame.image.load('./app/assets/screens/loading.png').convert_alpha()
